...
if os.name == "nt":
    ...
    lib = CDLL(Path("../lib/libdarknet.so").resolve(), RTLD_GLOBAL)
...
def performDetect(imagePath="../data/dog.jpg", thresh=0.25, configPath="../cfg/yolov4.cfg",
